...
if (projectId === 'startjourneyella') {
    ...
    document.getElementById('gallery1').outerHTML = '<a href="https://pbs.twimg.com/media/FOWeyBuUYAMGuNf?format=jpg&name=large" target="_blank">' +
            '<img id="gallery1" src="https://pbs.twimg.com/media/FOWeyBuUYAMGuNf?format=jpg&name=large" alt=""></a>';
    document.getElementById('gallery2').outerHTML = '<a href="https://pbs.twimg.com/media/FOTHIhOVkAAiI_t?format=jpg&name=small" target="_blank">' +
            '<img id="gallery2" src="https://pbs.twimg.com/media/FOTHIhOVkAAiI_t?format=jpg&name=small" alt=""></a>';
    document.getElementById('gallery3').outerHTML = '<a href="https://pbs.twimg.com/media/FOTHIgxVgAELda9?format=jpg&name=small" target="_blank">' +
            '<img id="gallery3" src="https://pbs.twimg.com/media/FOTHIgxVgAELda9?format=jpg&name=small" alt=""></a>';
...
else if (projectId === 'kaizokuella16') {
    document.getElementById('hastag').innerHTML = '#KaizokuElla16';
    document.getElementById('textProject').innerHTML = 'Bagaikan Bajak Laut yang melakukan perjalanan menuju harta karun, begitu pun Ella yang melakukan perjalanannya selama hampir 16 tahun (saat ini) untuk menuju ke cita-citanya. 🤍<br><br> Dengan ini kami persembahkan project ulang tahun ke 16 Ella yang bertajuk #KaizokuElla16';
    document.getElementById('tanggalProject').innerHTML = '3 Agustus 2022';
    document.getElementById('imageUtama').src = 'https://pbs.twimg.com/media/FZfY3SgUYAA9D-J?format=jpg&name=small';
    document.getElementById('gallery1').outerHTML = '<a href="https://pbs.twimg.com/media/Farn1hWUsAE_1Wp?format=jpg&name=medium" target="_blank">' +
    '<img id="gallery1" src="https://pbs.twimg.com/media/Farn1hWUsAE_1Wp?format=jpg&name=medium" alt=""></a>';
    document.getElementById('gallery2').outerHTML = '<a href="https://pbs.twimg.com/media/Faq7Br8agAA2I9o?format=jpg&name=medium" target="_blank">' +
        '<img id="gallery2" src="https://pbs.twimg.com/media/Faq7Br8agAA2I9o?format=jpg&name=medium" alt=""></a>';
        
document.getElementById('gallery3').outerHTML = '<a href="https://pbs.twimg.com/media/Far1nWfUcAAWIFd?format=jpg&name=900x900" target="_blank">' +
        '<img id="gallery3" src="https://pbs.twimg.com/media/Far1nWfUcAAWIFd?format=jpg&name=900x900" alt=""></a>';
        
   document.getElementById('gallery4').outerHTML = '<a href="https://pbs.twimg.com/media/Far1mkCVsAEQ5dy?format=jpg&name=900x900" target="_blank">' +
        '<img id="gallery4" src="https://pbs.twimg.com/media/Far1mkCVsAEQ5dy?format=jpg&name=900x900" alt=""></a>';
    document.getElementById('gallery5').src = '';
    document.getElementById('gallery6').src = '';
    document.getElementById('gallery7').src = '';
    // Menyesuaikan href tombol
    ...
    document.getElementById('gallery1').outerHTML = '<a href="https://pbs.twimg.com/media/FbOIH7XVUAErCjh?format=jpg&name=medium" target="_blank">' +
        '<img id="gallery" src="https://pbs.twimg.com/media/FbOIH7XVUAErCjh?format=jpg&name=medium" alt=""></a>';
...
document.getElementById('gallery2').outerHTML = '<a href="https://pbs.twimg.com/media/F3Zhj52asAESxTL?format=jpg&name=900x900" target="_blank">' +
            '<img id="gallery2" src="https://pbs.twimg.com/media/F3Zhj52asAESxTL?format=jpg&name=900x900" alt=""></a>';
document.getElementById('gallery3').outerHTML = '<a href="https://pbs.twimg.com/media/F3Zhj6AbMAA2Xn7?format=jpg&name=900x900" target="_blank">' +
        '<img id="gallery3" src="https://pbs.twimg.com/media/F3Zhj6AbMAA2Xn7?format=jpg&name=900x900" alt=""></a>';
document.getElementById('gallery4').outerHTML = '<a href="https://pbs.twimg.com/media/F3V2jZiaEAA02CG?format=jpg&name=small" target="_blank">' +
                    '<img id="gallery4" src="https://pbs.twimg.com/media/F3V2jZiaEAA02CG?format=jpg&name=small" alt=""></a>';
document.getElementById('gallery5').outerHTML = '<a href="https://pbs.twimg.com/media/F3V2jZkbIAAv21i?format=jpg&name=small" target="_blank">' +
                    '<img id="gallery5" src="https://pbs.twimg.com/media/F3V2jZkbIAAv21i?format=jpg&name=small" alt=""></a>';
document.getElementById('gallery6').outerHTML = '<a href="https://pbs.twimg.com/media/F3V2jZrasAAgHkm?format=jpg&name=small" target="_blank">' +
                    '<img id="gallery6" src="https://pbs.twimg.com/media/F3V2jZrasAAgHkm?format=jpg&name=small" alt=""></a>';
    // Menyesuaikan href tombol
...
document.getElementById('').outerHTML = '<a href="URL_tautan_gambar1" target="_blank">' +
    ...
    document.getElementById('gallery1').outerHTML = '<a href="https://ellatheria.my.id/merchandiseimg/merchandise_banner.jpg" target="_blank">' +
